		...
		jsPlumbUtil.extend(p, j, {
			...
			setHover: function(a) {
				if(this._jsPlumb && !this._jsPlumb.instance.isConnectionBeingDragged())
					for(var b = 0, c = this._jsPlumb.overlays.length; c > b; b++) this._jsPlumb.overlays[b][a ? "addClass" : "removeClass"](this._jsPlumb.instance.hoverClass)
			},
			...
			s = window.jsPlumbInstance = function(d) {
							...
							if(f && t.isDragSupported(b, e) && !t.isAlreadyDraggable(b, e)) {
								...
								g[j] = a.wrap(g[j], function() {
									return e.setHoverSuspended(!0), e.select({
										...
										target: b
									}).addClass(e.elementDraggingClass + " " + e.targetElementDraggingClass, !0), e.setConnectionBeingDragged(!0), g.canDrag ? d.canDrag() : void 0
									...
									I(b, a), e.removeClass(b, "jsPlumb_dragged"), e.setHoverSuspended(!1), e.select({
										...
										target: b
									}).removeClass(e.elementDraggingClass + " " + e.targetElementDraggingClass, !0), e.setConnectionBeingDragged(!1), e.dragManager.dragEnded(b)
								});
								var k = Y(b);
								x[k] = !0;
								var l = x[k];
				...
				this.unregisterEndpoint = function(a) {
					...
					var b = {
						...
						f = function(a) {
							if(null != a && null == b.connections[a.id] && (null != a._jsPlumb && a.setHover(!1), b.connections[a.id] = a, b.connectionCount++, d))
								for(var c = 0; c < a.endpoints.length; c++) a.endpoints[c]._deleteOnDetach && g(a.endpoints[c])
						},
						g = function(a) {
							if(null != a && null == b.endpoints[a.id] && (null != a._jsPlumb && a.setHover(!1), b.endpoints[a.id] = a, b.endpointCount++, d))
				...
				if(!t && jsPlumb.isDragSupported(this.element)) {
					var d = {
						...
						q = function() {
							...
							var a = !0;
							if(this.isEnabled() || (a = !1), null != e || this.isSource || (a = !1), this.isSource && this.isFull() && !this.dragAllowedWhenFull && (a = !1), null == e || e.isDetachable() || (a = !1), a === !1) return h.stopDrag && h.stopDrag(this.canvas), n.stopDrag(), !1;
							...
							}), e.pending = !0, e.addClass(h.draggingClass), this._jsPlumb.floatingEndpoint.addClass(h.draggingClass), h.fire("connectionDrag", e);
							else {
								f = !0, e.setHover(!1);
			...
			this.paint = function(d) {
				if(null !== d) {
					...
					for(var e = this.getSegments(), j = {
							path: ""
						}, k = [this.x, this.y, this.w, this.h], m = 0; m < e.length; m++) j.path += jsPlumb.Segments.vml.SegmentRenderer.getPath(e[m]), j.path += " ";
					if(d.outlineColor) {
